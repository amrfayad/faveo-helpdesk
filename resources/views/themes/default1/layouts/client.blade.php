			...
			<div class="clearfix"></div>
                    ...
                    <div class="row">
						<div class="site-info col-md-6">
                            <p class="text-muted">Copyright &copy; {!! date('Y') !!}  <a href="{!! $company->website !!}">{!! $company->company_name !!}</a>. All rights reserved. Powered by <a href="http://www.amrfayad.com/">Amr Fayad</a></p>
                        </div>
					</div>
		</footer><!-- #colophon -->
                    <!-- jQuery 2.1.1 -->
