...
?>
                            ...
                            <footer class="main-footer">
                                ...
                                ?>
                                <strong>Copyright &copy; {!! date('Y') !!}  <a href="{!! $company->website !!}">{!! $company->company_name !!}</a>.</strong> All rights reserved. Powered by <a href="http://www.amrfayad.com/" target="blank">Amr Fayad</a>
                            </footer>
                    </div><!-- ./wrapper -->
